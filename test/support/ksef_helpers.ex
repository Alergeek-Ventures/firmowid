defmodule Firmowid.KsefTestHelpers do
  ...
  def build_domestic_invoice(opts \\ []) do
    ...
    buyer_id = Keyword.get(opts, :buyer_id, :nip)
    ...
    attrs = %{
      ...
      buyer_type: :company,
      buyer_nip: if(buyer_id == :nip, do: "9876543210"),
  ...
  def build_reverse_charge_invoice(opts \\ []) do
    attrs = %{
      ...
      buyer_type: :company,
      buyer_nip: nil,
      buyer_eu_country_code: "DE",
      buyer_eu_vat_number: "123456789",
  ...
  def build_eu_vat_invoice(opts \\ []) do
    attrs = %{
      ...
      buyer_type: :company,
      buyer_nip: nil,
      buyer_eu_country_code: "FR",
      buyer_eu_vat_number: "FR12345678901",
  ...
  def build_other_id_invoice(opts \\ []) do
    attrs = %{
      ...
      buyer_type: :company,
      buyer_nip: nil,
      buyer_eu_country_code: nil,
      buyer_eu_vat_number: nil,
      buyer_other_id: "US123456789",
      buyer_other_id_country: "US",
