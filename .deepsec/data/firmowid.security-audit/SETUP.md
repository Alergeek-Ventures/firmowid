# Agent setup for `firmowid.security-audit`

This is a deepsec scanning workspace. Project `firmowid.security-audit` was just registered
(target: `..`). Setup is incomplete — `data/firmowid.security-audit/INFO.md`
...
2. **Fill in `data/firmowid.security-audit/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id firmowid.security-audit
pnpm deepsec process --project-id firmowid.security-audit
```
