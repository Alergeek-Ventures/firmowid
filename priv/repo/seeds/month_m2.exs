    ...
    txn_ghostpet =
      Helpers.seed_transaction!(
        %{
          ...
          debtor_account: "N/A",
          amount: Helpers.money!("USD", 5_950.00),
    ...
    txn_flatmate =
      Helpers.seed_transaction!(
        %{
          ...
          debtor_account: "N/A",
          amount: Helpers.money!("GBP", 4_480.00),
          booking_date: booking,
    ...
    txn_taco =
      Helpers.seed_transaction!(
        %{
          ...
          amount: Helpers.money!("EUR", 7_800.00),
          booking_date: booking,
    ...
    txn_thb_in =
      Helpers.seed_transaction!(
        %{
          ...
          amount: Helpers.money!("THB", 150_000.00),
    ...
    txn_thb_pln =
      Helpers.seed_transaction!(
        %{
          ...
          amount: Helpers.money!("PLN", 4_800.00),
          booking_date: Helpers.date_months_ago(2, 9),
          bank_account_id: banks.pln.id,
          skip_invoicing: true,
    ...
    txn_wage_tomek =
      Helpers.seed_transaction!(
        %{
          ...
          debtor_name: "Bytecraft Collective sp. z o.o.",
          debtor_account: "PL61105000997603123456789012",
          amount: Helpers.money!("PLN", -4_320.00),
          booking_date: wage_booking,
          bank_account_id: banks.pln.id,
          skip_invoicing: true,
    ...
    txn_wage_sable =
      Helpers.seed_transaction!(
        %{
          ...
          debtor_name: "Bytecraft Collective sp. z o.o.",
          debtor_account: "PL61105000997603123456789012",
          amount: Helpers.money!("PLN", -1_800.00),
          booking_date: wage_booking,
          bank_account_id: banks.pln.id,
          skip_invoicing: true,
    ...
    txn_wage_jules =
      Helpers.seed_transaction!(
        %{
          ...
          debtor_name: "Bytecraft Collective sp. z o.o.",
          debtor_account: "PL61105000997603123456789012",
          amount: Helpers.money!("PLN", -3_510.00),
          booking_date: wage_booking,
          bank_account_id: banks.pln.id,
          skip_invoicing: true,
    ...
    txn_wage_maren =
      Helpers.seed_transaction!(
        %{
          ...
          debtor_name: "Bytecraft Collective sp. z o.o.",
          debtor_account: "PL61105000997603123456789012",
          amount: Helpers.money!("PLN", -3_080.00),
          booking_date: wage_booking,
          bank_account_id: banks.pln.id,
          skip_invoicing: true,
