defmodule FirmowidWeb.Landing.Views.TermsOfService do
  ...
  import FirmowidWeb.Landing.Components.Landing, only: [landing_navbar: 1, cta_footer: 1]
  ...
  def render(assigns) do
    ...
    <div class="bg-grey-100 flex min-h-screen flex-col">
      ...
      <article class="prose prose-neutral mx-auto max-w-3xl px-6 pt-32 pb-20 lg:px-10">
        ...
        <p>
          ...
          (dalej: „Usługa"), dostępnej pod adresem <a
            href="https://firmowid.pl"
            class="text-orange-700 hover:underline"
          >firmowid.pl</a>.
        </p>
        <p>
          Usługodawcą jest <strong>Alergeek Ventures sp. z o.o.</strong> z siedzibą w Krakowie,
          ...
          (dalej: „Usługodawca" lub „Alergeek Ventures").
        </p>
        <p>
        ...
        <p>
          Zasady przetwarzania danych osobowych określa <a
            href="/polityka-prywatnosci"
            class="text-orange-700 hover:underline"
          >
            Polityka Prywatności</a>, stanowiąca integralną część niniejszego Regulaminu.
        </p>
        ...
        <p>
          ...
          <a href="mailto:contact@alergeek.ventures" class="text-orange-700 hover:underline">
