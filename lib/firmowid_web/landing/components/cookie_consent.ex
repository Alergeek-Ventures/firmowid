        ...
        <div class="rounded-xl border border-white/10 bg-black/95 px-6 py-5 shadow-2xl backdrop-blur-sm">
          <div class="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex-1 text-sm text-white/80">
              <p>
                {gettext(
                  "We always monitor application errors to keep the service reliable. After accepting, we may additionally store analytics cookies, enable diagnostic session recordings, and associate the data with the logged-in user."
                )}
                ...
                >
                   {pgettext("cookie-policy-link", "Privacy Policy")}</.link>.
              </p>
            </div>
