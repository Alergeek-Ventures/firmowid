      ...
      <%= if @invoice.invoice_type == :poland do %>
        <div class="flex justify-between items-center">
          ...
          <span>
            {Money.new(
              @invoice.currency,
              @invoice |> Firmowid.SalesInvoices.SalesInvoice.get_net_value()
            )}
          </span>
        </div>
        <div class="flex justify-between items-center">
          ...
          <span>
            {Money.new(
              @invoice.currency,
              @invoice |> Firmowid.SalesInvoices.SalesInvoice.get_vat_value()
            )}
          </span>
        </div>
        <div class="flex justify-between items-center">
          ...
          <span class="font-bold leading-tight text-sm">
            {Money.new(
              @invoice.currency,
              @invoice |> Firmowid.SalesInvoices.SalesInvoice.get_gross_value()
            )}
          </span>
        </div>
      <% end %>
