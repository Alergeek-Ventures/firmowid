defmodule FirmowidWeb.Infrastructure.UserAuth do
  ...
  the current_user:
      ...
      defmodule FirmowidWeb.PageLive do
        ...
        on_mount {FirmowidWeb.Infrastructure.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{FirmowidWeb.Infrastructure.UserAuth, :ensure_authenticated}] do
