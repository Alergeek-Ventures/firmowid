defmodule FirmowidWeb.Infrastructure.Plugs.FilteredRequestTracker do
  @moduledoc """
  ...
  Or with custom ignored paths:
      ...
      plug FirmowidWeb.Infrastructure.Plugs.FilteredRequestTracker, ignore_paths: ["/admin", "/health", "/metrics"]
  """
