defmodule FirmowidWeb.Infrastructure.Utilities.PolishQuantityTest do
  ...
  test "uses plural-many form for teen endings" do
  ...
  test "uses plural-few form after non-teen values ending in two through four" do
  ...
  test "uses plural-many form for zero and values ending in other digits" do
