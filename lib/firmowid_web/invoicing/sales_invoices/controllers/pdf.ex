...
# Duplicate branch handling mirrors shared controller behavior but lives in a
# separate feature boundary; unifying it would require non-trivial
# cross-controller extraction beyond a small local refactor.
